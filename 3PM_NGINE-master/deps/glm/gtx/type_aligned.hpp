...
namespace glm
{
	...
	/// Low qualifier 32 bit unsigned integer aligned scalar type.
	/// @see gtx_type_aligned
	GLM_ALIGNED_TYPEDEF(lowp_unsigned int, aligned_lowp_unsigned int, 4);
	...
	/// Medium qualifier 32 bit unsigned integer aligned scalar type.
	/// @see gtx_type_aligned
	GLM_ALIGNED_TYPEDEF(mediump_unsigned int, aligned_mediump_unsigned int, 4);
	...
	/// High qualifier 32 bit unsigned integer aligned scalar type.
	/// @see gtx_type_aligned
	GLM_ALIGNED_TYPEDEF(highp_unsigned int, aligned_highp_unsigned int, 4);
	...
	/// Default qualifier 32 bit unsigned integer aligned scalar type.
	/// @see gtx_type_aligned
	GLM_ALIGNED_TYPEDEF(unsigned int, aligned_unsigned int, 4);
